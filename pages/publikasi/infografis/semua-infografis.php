        ...
        <div class="wrapper">
            <div class="flex column gap-12">
                <div class="flex column gap-5">
                    <span class="display-lg">Semua Infografis</span>
                    <span class="body">Beragam infografis pendidikan untuk mendukung implementasi kebijakan dan peningkatan mutu layanan.</span>
                </div>
                            ...
                            <div class="flex column gap-5">
                                <div class="flex wrap gap-4 items-center">
                                    <div class="filter-terpilih">
                                        <div class="flex py-3 px-5 gap-5 items-center rounded-8 surface-gray-5 border-subdued">
