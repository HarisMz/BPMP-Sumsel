...
<main>
    <section class="container py-0 interactive-default" style="height: 390px;">
        <div class="wrapper column gap-4 py-9">
            ...
            <div class="display-lg text-inverse">Berita</div>
        </div>
    </section>
    <section class="container surface-default py-0" style="overflow: visible; height: 385px;">
        <div class="wrapper items-center" style="height: 640px; transform: translateY(-256px);">
