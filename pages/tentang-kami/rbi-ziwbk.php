...
<main>
    <section class="container hero py-0 darken left" style="background-image: url('/assets/images/ziwbk-hero.jpg');">
    ...
    <section class="container pt-9 pb-14 surface-subdued">
        <div class="wrapper">
    ...
    <section class="container py-0 surface-default">
        <div class="wrapper py-14">
            <div class="flex column-tablet items-center justify-center gap-12">
                ...
                <img src="/assets/images/integritas.png" alt="Integritas">
                <img src="/assets/images/tolak-gratifikasi.png" alt="Tolak Gratifikasi">
            </div>
        </div>
    </section>
</main>
