...
<body id="inovasi-eksternal" data-slug="inovasi-dan-layanan">

<?php include './modules/header.php'; ?>

<main>
    <section class="container hero py-0 darken left" style="background-image: url('/assets/images/hero-eksternal.png');">
    ...
    <section class="container py-14 surface-subdued">
        <div class="wrapper flex column gap-11">
            ...
            <div class="grid grid-2 grid-1-mobile gap-5">
                ...
                <div style="height: 320px;">
                    <img src="/assets/images/eksternal-5.png" alt="Foto Serasan" style="height: 100%; width: 100%; object-fit: cover; border-radius: 8px;">
                </div>
            </div>
        </div>
    </section>
