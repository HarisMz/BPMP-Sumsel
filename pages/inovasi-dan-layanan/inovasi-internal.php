...
<body id="inovasi-internal" data-slug="inovasi-dan-layanan">
        ...
        <div class="wrapper">
            <div class="grid grid-2 grid-1-mobile gap-5">
                ...
                <div style="height: 320px;">
                    <img src="/assets/images/internal-1.png" alt="Foto Senin Berpijar" style="height: 100%; width: 100%; object-fit: cover; border-radius: 8px;">
                </div>
                <div style="height: 320px;">
                    <img src="/assets/images/internal-2.png" alt="Foto Senin Berpijar" style="height: 100%; width: 100%; object-fit: cover; border-radius: 8px;">
                </div>
                <div style="height: 320px;">
                    <img src="/assets/images/internal-3.png" alt="Foto Senin Berpijar" style="height: 100%; width: 100%; object-fit: cover; border-radius: 8px;">
                </div>
            </div>
        </div>
    </section>
    <section class="container py-14 surface-subdued">
        <div class="wrapper flex column gap-11">
            ...
            <div class="grid grid-3 grid-1-mobile gap-5">
                ...
                <div style="height: 240px;">
                    <img src="/assets/images/internal-5.png" alt="Foto Rapat Rutin" style="height: 100%; width: 100%; object-fit: cover; border-radius: 8px;">
                </div>
                <div style="height: 240px;">
                    <img src="/assets/images/internal-6.png" alt="Foto Rapat Rutin" style="height: 100%; width: 100%; object-fit: cover; border-radius: 8px;">
                </div>
            </div>
        </div>
    </section>
    <section class="container py-14 surface-default">
        <div class="wrapper flex column gap-11">
            ...
            <div class="grid grid-2 grid-1-mobile gap-5">
                ...
                <div style="height: 320px;">
                    <img src="/assets/images/internal-8.png" alt="Foto Kombel Cerdas" style="height: 100%; width: 100%; object-fit: cover; border-radius: 8px;">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-2 grid-1-mobile gap-11">
                <div class="flex column justify-center gap-7">
                    <div class="flex column gap-3">
                        ...
                        <span class="display-sm">Mari NgeLapor Oleh-oleh</span>
                    </div>
                    <span class="body">Mang Oleh atau Mari Ngelapor Oleh-oleh merupakan inovasi internal BPMP Provinsi Sumatera Selatan untuk pengendalian gratifikasi dan penguatan nilai-nilai integritas kejujuran pegawai dalam melaksanakan tugas kedinasan serta implemtasi tata nilai (core values) Aparatur Sipil Negara (ASN) yang Berorientasi Pelayanan, Akuntabel, Kompeten, Harmonis, Loyal, Adaptif dan Kolaboratif (BerAKHLAK).</span>
                </div>
                <div style="height: 400px;">
                    <img src="/assets/images/internal-9.jpg" alt="Mari NgeLapor Oleh-oleh" style="height: 100%; width: 100%; object-fit: cover; border-radius: 8px;">
                </div>
            </div>
        </div>
    </section>
    <section class="container py-14 surface-default">
        <div class="wrapper">
            <div class="grid grid-2 flex-mobile column-reverse-mobile gap-11">
                ...
                <div class="flex column justify-center gap-7">
                    <div class="flex column gap-3">
                        <span class="headline-xs">Juker</span>
                        <span class="display-sm">Jumat Kelas Olahraga dan Belajar</span>
                    </div>
                    <span class="body">Jumat Kelakar atau Jumat Kelas Olahraga dan Belajar merupakan wahana belajar yang dirancang khusus untuk pegawai dengan pendekatan andragogi, experiential learning, participatory learning yang kasual dan menyenangkan. Jumat Kelakar tidak hanya sekadar forum untuk meningkatkan skill, knowledge, dan attitude tetapi juga menjadi sarana untuk membangun profesionalisme dan ikatan kekeluargaan yang lebih kuat di lingkungan pegawai BPMP Provinsi Sumatera Selatan.</span>
                </div>
            </div>
        </div>
    </section>
