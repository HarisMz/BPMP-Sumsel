            ...
            <div class="flex column items-center gap-11">
                ...
                <div class="grid grid-4 grid-2-tablet grid-1-mobile gap-7">
                    <div class="flex column justify-between gap-5 p-7 surface-default rounded-8">
                        ...
                        <a href="/inovasi-dan-layanan/pengaduan/pengaduan-masyarakat" class="button large right full" data-icon="open_in_new">
                            Buat Laporan
                        </a>
                    </div>
                    <div class="flex column justify-between gap-5 p-7 surface-default rounded-8">
                    ...
                    <div class="flex column justify-between gap-5 p-7 surface-default rounded-8">
                        ...
                        <a href="/inovasi-dan-layanan/pengaduan/pelaporan-gratifikasi" class="button large right full" data-icon="open_in_new">
                            Buat Laporan
                        </a>
                    </div>
                </div>
