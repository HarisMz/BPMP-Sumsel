            ...
            <div class="flex column gap-10">
                ...
                <div class="grid grid-3 gap-7">
                    <div class="flex column p-7 gap-5 surface-subdued rounded-8">
                        ...
                        <div class="body-lg"><b>UU No. 25 Tahun 2009 tentang Pelayanan Publik</b></div>
                        <a href="#" class="button secondary small right" data-icon="download">
                            Unduh Dokumen
                        </a>            
                    </div>
                    <div class="flex column p-7 gap-5 surface-subdued rounded-8">
                        ...
                        <div class="body-lg"><b>Permenpan RB No. 15 Tahun 2014 tentang Pedoman Standar Pelayanan</b></div>
                        <a href="#" class="button secondary small right" data-icon="download">
                            Unduh Dokumen
                        </a>  
                    </div>
                    <div class="flex column p-7 gap-5 surface-subdued rounded-8">
                        ...
                        <div class="body-lg"><b>Keputusan Kepala BPMP Provinsi Sumatera Salatan No. 2207</b></div>
                        <a href="#" class="button secondary small right" data-icon="download">
                            Unduh Dokumen
                        </a>     
                    </div>
