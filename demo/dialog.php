...
<head>
	<meta charset="utf-8">
	<title>Peraga Komponen: Dialog</title>
	<?php include($_SERVER['DOCUMENT_ROOT'] . '/modules/loadlist.php'); ?>
</head>
<body class="p-8 surface-gray-10">
	<h1 class="headline-sm">Dialog</h1>
	<div class="spacer-4 vertical"></div>
	<p class="display-sm">Kotak modal untuk menampilkan pesan atau interaksi lebih lanjut.</p>

	<div class="spacer-8 vertical"></div>

	<p class="subheading pb-2">Dialog dengan Berbagai Gaya</p>
	<span class="helper pb-2">Dialog ditampilkan dalam overlay yang menutupi keseluruhan layar.</span>
	<div class="spacer-4 vertical"></div>
